...
{
    public class SinglesViewModel : BaseViewModel, ISupportIncrementalLoading
    {
        ...
        private async Task LoadPostsGroupAsync()
        {
            ...
            {
                Debug.WriteLine($"SinglesViewModel | LoadPostsGroupAsync | {ex}");
            }
            finally
            {
                IsRefreshing = false;
        ...
        public SinglesViewModel(WordpressService wordpressService)
        {
        ...
        private async Task LoadMoreItemsAsync()
        {
            ...
            {
                Debug.WriteLine($"SinglesViewModel | LoadMoreItemsAsync | {ex}");
            }
            finally
            {
