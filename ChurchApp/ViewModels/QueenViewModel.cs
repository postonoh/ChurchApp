...
{
    public class QueenViewModel : BaseViewModel, ISupportIncrementalLoading
    {
        ...
        private async Task LoadPostsGroupAsync()
        {
            ...
            {
                Debug.WriteLine($"QueenViewModel | LoadPostsGroupAsync | {ex}");
            }
            finally
            {
                IsRefreshing = false;
        ...
        public QueenViewModel(WordpressService wordpressService)
        {
        ...
        private async Task LoadMoreItemsAsync()
        {
            ...
            {
                Debug.WriteLine($"QueenViewModel | LoadMoreItemsAsync | {ex}");
            }
            finally
            {
