...
{
    public class PostViewModel : BaseViewModel, ISupportIncrementalLoading
    {
        ...
        private bool _arePostsNotAvailable = false;
        ...
        private bool _arePostsAvailable = true;
        public bool ArePostsAvailable
        {
            get => _arePostsAvailable;
            set { _arePostsAvailable = value; OnPropertyChanged(); }
        }
        ...
        private async Task LoadPostsAsync()
        {
            ...
            {
                Debug.WriteLine($"PostViewModel | LoadPostsAsync | {ex}");
            }
            finally
            {
                IsRefreshing = false;
        ...
        public PostViewModel(WordpressService wordpressService)
        {
        ...
        private async Task LoadMoreItemsAsync()
        {
            ...
            {
                Debug.WriteLine($"PostViewModel | LoadMoreItemsAsync | {ex}");
            }
            finally
            {
