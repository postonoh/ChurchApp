...
{
    public class CouplesViewModel : BaseViewModel, ISupportIncrementalLoading
    {
        ...
        private async Task LoadPostsGroupAsync()
        {
            ...
            {
                Debug.WriteLine($"CouplesViewModel | LoadPostsGroupAsync | {ex}");
            }
            finally
            {
                IsRefreshing = false;
        ...
        public CouplesViewModel(WordpressService wordpressService)
        {
        ...
        private async Task LoadMoreItemsAsync()
        {
            ...
            {
                Debug.WriteLine($"CouplesViewModel | LoadMoreItemsAsync | {ex}");
            }
            finally
            {
